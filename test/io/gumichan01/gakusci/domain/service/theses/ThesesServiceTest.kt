...
class ThesesServiceTest {
    ...
    private val clientMock: ThesesClient = mockk {
        coEvery { retrieveResults(QueryParam("lorem", SearchType.RESEARCH, uri = "/query=lorem")) } returns ThesesResponse(
            ThesesResponseBody(
                3, 0, listOf(
        ...
        coEvery { retrieveResults(QueryParam("ipsum", SearchType.RESEARCH, uri = "/query=ipsum")) } returns ThesesResponse(
            ThesesResponseBody(
                1, 0, listOf(
