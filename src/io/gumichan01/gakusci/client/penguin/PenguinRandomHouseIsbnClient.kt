...
class PenguinRandomHouseIsbnClient : IClient<PenguinRandomHouseResponse> {
    ...
    override suspend fun retrieveResults(queryParam: QueryParam): PenguinRandomHouseResponse? {
